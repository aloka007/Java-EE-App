...
-- Dumping data for table smart_rms.customer: ~12 rows (approximately)
...
-- Dumping data for table smart_rms.reservation: ~6 rows (approximately)
...
-- Dumping data for table smart_rms.reservation_table: ~11 rows (approximately)
