...
-- Dumping data for table smart_rms.bill_order_item: ~27 rows (approximately)
...
INSERT INTO `customer` (`customer_id`, `name`, `password`, `birthday`, `email`, `contact_no`) VALUES
	...
	(25, 'Dave Hardy', NULL, NULL, 'dave@eg.com', '0800555555');
...
-- Dumping data for table smart_rms.customer_order: ~4 rows (approximately)
...
INSERT INTO `customer_order` (`order_no`, `order_time`, `table_no`, `ordered_by`, `accepted_by`, `cust_id`, `cust_name`, `status`) VALUES
	(1121, '2017-01-13 11:32:14', 0, 'rec01', 'chef01', NULL, 'test', 1),
	(1122, '2017-01-13 15:10:13', 0, 'rec01', 'chef01', NULL, 'Test02', 0),
	(1123, '2017-01-14 00:05:47', 1, 'rec01', 'chef01', NULL, 'test3', 0),
	(1124, '2017-01-14 00:06:17', 2, 'rec01', 'chef01', NULL, 'test 4', 1),
...
INSERT INTO `ingredient` (`id`, `name`, `description`, `unit`, `amount`, `warn`, `crit`) VALUES
	(0, 'Cheese', NULL, 'KG', 7.730, 9.000, 1.000),
	(1, 'Beef', NULL, 'KG', 14.500, 5.000, 2.000),
	(2, 'Milk', NULL, 'L', 6.000, 4.000, 2.000),
	(4, 'Bacon', NULL, 'KG', 4.150, 3.000, 2.000),
	(5, 'Chicken', NULL, 'KG', 1.700, 4.000, 3.000);
...
-- Dumping data for table smart_rms.order_item: ~12 rows (approximately)
...
-- Dumping data for table smart_rms.reservation: ~0 rows (approximately)
DELETE FROM `reservation`;
/*!40000 ALTER TABLE `reservation` DISABLE KEYS */;
INSERT INTO `reservation` (`res_id`, `placed_time`, `date`, `meal_time`, `placed_by`, `customer_id`, `status`) VALUES
	(1020, '2017-01-13 11:55:35', '2017-01-13', 'LUNCH', 'rec01', 25, 'NO-SHOW');
...
-- Dumping data for table smart_rms.reservation_table: ~2 rows (approximately)
