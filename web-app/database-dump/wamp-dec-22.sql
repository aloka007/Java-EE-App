...
INSERT INTO `bill` (`id`, `waiter_id`, `cashier_id`, `customer_name`, `date`, `amount`, `discount`, `tax`, `sub_total`, `tip`, `total`, `pay_mode`) VALUES
	...
	(13, NULL, NULL, NULL, '2016-11-02 12:00:00', NULL, NULL, NULL, 100000.00, NULL, NULL, NULL),
	(14, NULL, NULL, NULL, '2016-11-04 10:52:35', NULL, NULL, NULL, 90000.00, NULL, NULL, NULL),
	(15, NULL, NULL, NULL, '2016-11-01 12:00:00', NULL, NULL, NULL, 84323.00, NULL, NULL, NULL),
	...
	(41, NULL, NULL, NULL, '2016-11-27 12:00:00', NULL, NULL, NULL, 112242.00, NULL, NULL, NULL),
	(42, NULL, NULL, NULL, '2016-11-28 12:00:00', NULL, NULL, NULL, 170054.00, NULL, NULL, NULL),
	(43, NULL, NULL, NULL, '2016-11-29 12:00:00', NULL, NULL, NULL, 133571.00, NULL, NULL, NULL),
	(44, '', 'null', 'hello', '2016-12-09 12:35:08', 3000.00, 0.00, 450.00, 3450.00, 0.00, 3450.00, NULL);
...
-- Dumping data for table smart_rms.bill_order_item: ~9 rows (approximately)
...
INSERT INTO `customer_order` (`order_no`, `order_time`, `table_no`, `ordered_by`, `accepted_by`, `cust_id`, `cust_name`, `status`) VALUES
	...
	(1111, '2016-11-30 14:09:32', 0, 'rec01', 'admin', NULL, 'Tharinda22', 0),
	(1112, '2016-11-30 14:13:47', 0, 'rec01', 'chef01', NULL, 'Tharinda22', 1),
...
INSERT INTO `ingredient` (`id`, `name`, `description`, `unit`, `amount`, `warn`, `crit`) VALUES
	(0, 'Cheese', NULL, 'KG', 8.300, 9.000, 1.000),
	(1, 'Beef', NULL, 'KG', 14.400, 5.000, 2.000),
	(2, 'Milk', NULL, 'L', 7.600, 4.000, 2.000),
	(3, 'Eggs', NULL, 'UNIT', 50.000, 20.000, 10.000),
	(4, 'Bacon', NULL, 'KG', 4.400, 3.000, 2.000);
...
-- Dumping data for table smart_rms.ingredient_consumption: ~38 rows (approximately)
...
-- Dumping data for table smart_rms.menu_item_ingredient: ~6 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `reservation` (
  ...
  `status` enum('PENDING','ACTIVE','COMPLETE','CANCELLED') DEFAULT 'PENDING',
  PRIMARY KEY (`res_id`),
...
INSERT INTO `reservation` (`res_id`, `placed_time`, `date`, `meal_time`, `placed_by`, `customer_id`, `status`) VALUES
	(1, '0000-00-00 00:00:00', '2016-09-19', 'LUNCH', '0', 0, 'PENDING'),
	(1000, '0000-00-00 00:00:00', '0000-00-00', 'DINNER', '0', 0, 'PENDING'),
	(1001, '0000-00-00 00:00:00', '2016-10-29', 'LUNCH', '0', 0, 'PENDING'),
	(1002, '2016-10-30 09:49:36', '2016-11-02', 'DINNER', '0', 0, 'PENDING'),
	(1003, NULL, '2016-11-07', 'LUNCH', NULL, 10, 'PENDING'),
	(1004, '2016-11-06 22:15:45', '2016-11-09', 'LUNCH', NULL, 11, 'PENDING'),
	(1005, '2016-11-06 22:34:27', '2016-11-07', 'DINNER', 'rec01', 12, 'PENDING'),
	(1006, '2016-11-09 12:52:29', '2016-12-01', 'LUNCH', 'rec01', 13, 'PENDING'),
	(1007, '2016-11-20 10:34:28', '2016-11-21', 'LUNCH', 'rec01', 14, 'PENDING'),
	(1008, '2016-11-23 21:45:07', '2016-11-24', 'LUNCH', 'rec01', 15, 'PENDING'),
	(1009, '2016-11-23 21:47:02', '2016-11-24', 'LUNCH', NULL, 16, 'PENDING'),
	(1010, '2016-11-24 06:04:28', '2016-11-25', 'LUNCH', 'rec01', 17, 'PENDING'),
	(1011, '2016-12-09 12:39:11', '2016-12-13', 'LUNCH', 'rec01', 18, 'PENDING');
