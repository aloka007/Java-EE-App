...
INSERT INTO `customer_order` (`order_no`, `order_time`, `table_no`, `ordered_by`, `accepted_by`, `cust_id`, `cust_name`, `status`) VALUES
	...
	(1070, '2016-09-06 21:40:48', 0, 'rec01', 'rec01', 0, 'Tharinda Aloka', 0),
	...
	(1111, '2016-11-30 14:09:32', 0, 'rec01', 'chef01', NULL, 'Tharinda22', 1),
...
INSERT INTO `ingredient` (`id`, `name`, `description`, `unit`, `amount`, `warn`, `crit`) VALUES
	(0, 'Cheese', NULL, 'KG', 9.400, 2.000, 1.000),
	(1, 'Beef', NULL, 'KG', 15.000, 5.000, 2.000),
	(2, 'Milk', NULL, 'L', 8.000, 4.000, 2.000),
	(3, 'Eggs', NULL, 'UNIT', 50.000, 20.000, 10.000),
	(4, 'Bacon', NULL, 'KG', 5.400, 3.000, 2.000);
...
-- Dumping data for table smart_rms.order_item: ~47 rows (approximately)
