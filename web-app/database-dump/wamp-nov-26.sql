...
-- Dumping data for table smart_rms.bill: ~0 rows (approximately)
DELETE FROM `bill`;
...
-- Dumping data for table smart_rms.bill_order: ~0 rows (approximately)
...
-- Dumping data for table smart_rms.bill_order_item: ~0 rows (approximately)
...
INSERT INTO `customer_order` (`order_no`, `order_time`, `table_no`, `ordered_by`, `accepted_by`, `cust_id`, `cust_name`, `status`) VALUES
	...
	(1077, '2016-09-08 21:00:02', 0, 'rec01', 'rec01', 0, 'Test Order', 3),
	(1081, '2016-09-10 15:22:18', 0, 'chef01', 'rec01', 0, 'Test Order 2', 3),
...
-- Dumping data for table smart_rms.reservation_table: ~23 rows (approximately)
