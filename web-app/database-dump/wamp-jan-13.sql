...
INSERT INTO `customer_order` (`order_no`, `order_time`, `table_no`, `ordered_by`, `accepted_by`, `cust_id`, `cust_name`, `status`) VALUES
	...
	(1077, '2016-09-08 21:00:02', 0, 'rec01', 'chef01', 0, 'Test Order', 1),
	(1081, '2016-09-10 15:22:18', 0, 'chef01', 'chef01', 0, 'Test Order 2', 1),
...
INSERT INTO `ingredient` (`id`, `name`, `description`, `unit`, `amount`, `warn`, `crit`) VALUES
	(0, 'Cheese', NULL, 'KG', 8.110, 9.000, 1.000),
	...
	(5, 'Chicken', NULL, 'KG', 6.200, 4.000, 3.000);
...
INSERT INTO `ingredient_consumption` (`id`, `ingredient_id`, `action`, `amount`, `time`) VALUES
	...
	(70, 5, 'CONSUME', 0.200, '2017-01-13 10:12:31');
...
-- Dumping data for table smart_rms.order_item: ~59 rows (approximately)
...
-- Dumping data for table smart_rms.reservation: ~10 rows (approximately)
